...
function updateFooter(msg) {
	...
	if(setTop){
		...
		button_elem.innerHTML = "<div style='position:absolute'>"+ID_Remainingwords+" " + wordsLeft + "</div>"
		button_elem.innerHTML += "<div style='margin-right:5px; float:right'>"+ID_Attempts+" " + attempt + "/" + maxAttempts+"</div>";
		...
		var button_elem = document.getElementById('answerBoxFooter');
		button_elem.innerHTML = "<div>"+ID_Remainingwords+" " + wordsLeft + "</div>"
		button_elem.innerHTML += "<div>"+ID_Attempts+" " + attempt + "/" + maxAttempts+"</div>";
		button_elem.innerHTML += "<div id='showAnswers'>" + msg + "</div>";
