...
processcircleUse1 = {
	...
	doUpdate: function() 
	{
		...
		for(i=0;i<window.parent.document.getElementsByClassName("cp-widget").length;i++){
			...
			if(window.parent.document.getElementsByClassName("cp-widget")[i].children[0].children[0].contentDocument.getElementById("processcirclewdgt") != null){
